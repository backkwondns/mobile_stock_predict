...
test_df = pd.read_csv(f"./data_dir/test_{target_stock}_{str_today}.csv")
...
loaded_Model = models.load_model(f"./models/my_model_{target_stock}")
...
mongo.upsert_DB(info.to_dict("records"), f"{target_stock}_PRED")
